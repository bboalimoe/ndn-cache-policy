...
public:
  ...
  virtual void
  SetRatio (std::vector<float> &vect) ;
...
virtual void
 ...
 virtual typename ns3::ndn::HitTraceTable*
 GetHtt();
...
protected:
  ...
  TracedCallback<Ptr<const Interest>,
       	  	  	  	  	  	  	  	  Ptr<const Data>
       	  	  	  	  	  	  	  	  >   m_cachehits_tag; ///< @brief trace of cachehits by tag

       TracedCallback<Ptr<const Interest>  >  m_cachemisses_tag; ///< @brief trace of cachehits by tag

private:
     //  typename ns3::ndn::HitTraceTable m_htt;// 公有继承吧
       //typename ns3::ndn::HitTraceTable v_htt;
};
