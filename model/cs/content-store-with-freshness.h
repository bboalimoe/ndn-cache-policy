...
static  Ptr<typename ns3::ndn::HitTraceTable> f_htt = Create<typename ns3::ndn::HitTraceTable>();
...
/////
/////  这里相当于 用一个2元vector来保存 两个policy 其中第一个是lru,lfu ,, 第二个是 custom policy中自己订制的policy
