...
void SetCsRatioByTag()
{
	/*
	1.get some data from the trace
	2.calculate the ratio for each tag based on the trace data
	3.set the ratio for each tag
	4.simulator go again?
	*/
   //主要是如何在simulator运行时,让cs-->中的policy参数改变..
	//
