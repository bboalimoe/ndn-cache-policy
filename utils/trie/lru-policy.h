...
struct lru_policy_traits
{
  ...
  **/
  ...
  struct policy 
  {
	  //////
	  /////
	  ////   这个list就是intrusive的  Container就是一个parent_trie的 trie结构
    typedef typename boost::intrusive::list< Container, Hook >    policy_container;
    
    // could be just typedefp
    ...
    public:
      ...
      type (Base &base)
        : base_ (base)      //base_   --->   trie_with_policy<FullKey, PayloadTraits, PolicyTraits>
        , max_size_ (100)
      {
      }
      ...
      update (typename parent_trie::iterator item)
      {
        ...
        // do relocation
    	  //place the *this to the end of the policy_container .....
