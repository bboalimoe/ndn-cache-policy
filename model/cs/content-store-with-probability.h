...
static  Ptr<typename ns3::ndn::HitTraceTable> pr_htt = Create<typename ns3::ndn::HitTraceTable>();
...
public:
	...
	/////
	/////
	/////     两个policy 一起  工作..  multi_policy_traits 是对两个policy的封装
  typedef ContentStoreImpl< ndnSIM::multi_policy_traits< boost::mpl::vector2< ndnSIM::probability_policy_traits, Policy > > > super;
//////
  /////
  //////  vector2< ndnSIM::probability_policy_traits, Policy >.index<0> ----> probability
