...
//////从ndnstack传interest到底层,或者是netdevice或者是tcp,udp等,这个不需要做处理.
bool
...
//////从ndnstack传data到底层,或者是netdevice或者是tcp,udp等,这个不需要做处理.
bool
...
///// here trigger the fw Oninterest
