...
//////   主要是定义了一个wrap,从中取第几个type....之类的东西,  应该是封存hook_type的把
/*
 * typedef detail::multi_type_container< typename boost::mpl::transform1<policy_traits, getHook>::type >  policy_hook_type;
 * */

template< class Vector >
struct multi_type_container    ///  inherit_linearly ---> http://cs.brown.edu/people/jwicks/boost/libs/mpl/doc/refmanual/inherit-linearly.html
...
////
  ...
  ////
  /////
  ////http://www.slac.stanford.edu/BFROOT/www/doc/workbook_backup_010108/examples/ex1/workdir/PARENT/boost/libs/mpl/doc/ref/Reference/at_c.html
  template<int N>
